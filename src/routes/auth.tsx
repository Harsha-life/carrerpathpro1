...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Log in or create your PathFinder AI account to take assessments and get career guidance.",
      },
      { property: "og:title", content: "Sign in — PathFinder AI" },
      { property: "og:description", content: "Access your career assessments and AI guidance." },
...
function AuthPage() {
  ...
  const signUp = async (e: React.FormEvent) => {
    ...
    setBusy(false);
    if (error) return toast.error(error.message);
    toast.success("Account created. You can start your first assessment.");
    navigate({ to: "/dashboard" });
  };
    ...
    <div className="surface-hero flex min-h-screen flex-col">
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="panel w-full max-w-md p-8">
          <h1 className="text-2xl font-semibold">Welcome to PathFinder AI</h1>
            ...
            <TabsContent value="register">
              <form onSubmit={signUp} className="grid gap-4 pt-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="reg-password" type="password" minLength={6} required value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
                <Button type="submit" disabled={busy}>
